...
timeline, an EASA minimum-rest calculator with a jet-lag shift plan, a curated New York
layover guide with crew recommendations and a currency converter, a role-aware packing
checklist, and a personal travel atlas.
...
├── Views/                  Today · Rest · City · Kit · Atlas
...
- `AppModel.flightStatus` is the config flag from the handoff: set it to `.delayed` to
  preview the amber "DELAYED 45 M" state (STD 09:20, STA 13:05).
